/*
fragment shader for prefiltering the environment map
out: vec4 frag_color
in: vec3 frag_position
uniform: samplerCube u_environment_map, float u_roughness
*/
#version 420 core
out vec4 frag_color;
in vec3 frag_position;
...
{		
    ...
    for(uint i = 0u; i < SAMPLE_COUNT; ++i)
    {
        ...
        if(NdotL > 0.0)
        {
            ...
            prefilteredColor += textureLod(u_environment_map, L, mipLevel).rgb * NdotL;
            totalWeight      += NdotL;
        }
    }
